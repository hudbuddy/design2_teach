...
class UserTypesControllerTest < ActionController::TestCase
  ...
  test "should create user_type" do
    assert_difference('UserType.count') do
      post :create, user_type: { deleted_at: @user_type.deleted_at, type: @user_type.type, user_id: @user_type.user_id }
    end
  ...
  test "should update user_type" do
    patch :update, id: @user_type, user_type: { deleted_at: @user_type.deleted_at, type: @user_type.type, user_id: @user_type.user_id }
    assert_redirected_to user_type_path(assigns(:user_type))
  end
